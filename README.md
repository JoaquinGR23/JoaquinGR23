...
| Java | Intermedio | POO | Backend | IntelliJ / Maven | En curso |
| Python | Intermedio | Multiparadigma | Scripts / Data | VS Code | Aprendido |
| JavaScript | Básico | Multiparadigma | Frontend | Node.js | En curso |
| Bash | Básico | Scripting | Automatización | Terminal | Aprendido |
